...
namespace Strassio.Core.Placement
{
    ...
    public sealed class IntersectionFixOptions
    {
        ...
        /// <summary>
        /// После удаления раздвинуть соседей того же ряда, чтобы на месте убранной стразы не
        /// осталось дырки (для «Удалить» и «Сдвинуть»). Сдвинутые так стразы попадают в ShiftedIndices.
        /// </summary>
