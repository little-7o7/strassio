...
> Правка камней, лицензия и автообновление — впереди (см. [что дальше](#что-дальше)).
...
| 3 | Правка и цвет | следующий |
| 4 | Прокачка линий и заливок | |
| 5 | Инструменты и подготовка к производству | |
| 6 | Лицензия и обновления | |
| 7 | Бета-тест с мастерами | |

### Доделать в докере (Этап 2)
- **Предпросмотр** — увидеть результат до того, как стразы появятся в документе.
- **Редактор таблицы камней** прямо в плагине: добавить, изменить, удалить размер и цвет, поменять порядок.
- Горизонтальная раскладка докера — для широких экранов.
- Маленькие картинки-схемы у каждого метода в списке.
- Экспорт и импорт настроек и таблицы камней — перенести на другой компьютер или раздать сотрудникам.
- Проверка на старых версиях CorelDRAW (X7, X8) и 32-битных.

### Правка и цвет (Этап 3)
...
### Прокачка линий и заливок (Этап 4)
