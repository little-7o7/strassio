...
### Векторы и производство

- **Подготовка линий:** смещение контура, параллельные линии, разрезать на равные части, соединить
  близкие концы, замкнуть, найти разрывы, развернуть направление, сгладить дрожащую линию,
  **центральная линия из толстой формы или буквы**, проверка (самопересечения, микросегменты, мусор, дубли).
- **Обводка всего дизайна** рядом страз на отступе.
- **Производство:** проверка тонких перемычек, раскладка по слоям по размерам (для ArtCAM),
  «чистые» круги для резки.
- **Пресеты** («Стебель тонкий») и **недавние настройки**, **несколько таблиц камней** (под разных поставщиков).
...
| 5 | Инструменты и подготовка к производству | ✅ готово |
| 6 | Лицензия и обновления | 🔧 в работе |
...
### Инструменты и производство (Этап 5) — ✅ готово
